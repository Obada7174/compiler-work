...
public class PythonParser extends Parser {
	...
	public static final int
		INDENT=1, DEDENT=2, NEWLINE=3, STRING=4, NUMBER=5, INTEGER=6, AND=7, AS=8, 
		ASSERT=9, ASYNC=10, AWAIT=11, BREAK=12, CASE=13, CLASS=14, CONTINUE=15, 
		...
		TRY=40, UNDERSCORE=41, WHILE=42, WITH=43, YIELD=44, NAME=45, STRING_LITERAL=46, 
		BYTES_LITERAL=47, DECIMAL_INTEGER=48, OCT_INTEGER=49, HEX_INTEGER=50, 
		BIN_INTEGER=51, FLOAT_NUMBER=52, IMAG_NUMBER=53, DOT=54, ELLIPSIS=55, 
		STAR=56, OPEN_PAREN=57, CLOSE_PAREN=58, COMMA=59, COLON=60, SEMI_COLON=61, 
		POWER=62, ASSIGN=63, OPEN_BRACK=64, CLOSE_BRACK=65, OR_OP=66, XOR=67, 
		AND_OP=68, LEFT_SHIFT=69, RIGHT_SHIFT=70, ADD=71, MINUS=72, DIV=73, MOD=74, 
		IDIV=75, NOT_OP=76, OPEN_BRACE=77, CLOSE_BRACE=78, LESS_THAN=79, GREATER_THAN=80, 
		EQUALS=81, GT_EQ=82, LT_EQ=83, NOT_EQ_1=84, NOT_EQ_2=85, AT=86, ARROW=87, 
		ADD_ASSIGN=88, SUB_ASSIGN=89, MULT_ASSIGN=90, AT_ASSIGN=91, DIV_ASSIGN=92, 
		MOD_ASSIGN=93, AND_ASSIGN=94, OR_ASSIGN=95, XOR_ASSIGN=96, LEFT_SHIFT_ASSIGN=97, 
		RIGHT_SHIFT_ASSIGN=98, POWER_ASSIGN=99, IDIV_ASSIGN=100, SKIP_=101, UNKNOWN_CHAR=102;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "INDENT", "DEDENT", "NEWLINE", "STRING", "NUMBER", "INTEGER", "AND", 
			...
			"WHILE", "WITH", "YIELD", "NAME", "STRING_LITERAL", "BYTES_LITERAL", 
	...
	public final DecoratorContext decorator() throws RecognitionException {
		...
		try {
			...
			if (_la==OPEN_PAREN) {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 4863925555409455152L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 12673L) != 0)) {
					{
					setState(244);
					arglist();
					}
	...
	public final ParametersContext parameters() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 4683780998008143872L) != 0)) {
				{
				setState(277);
				typedargslist();
				}
			...
			case NAME:
				...
				if (_la==COMMA) {
					...
					case STAR:
						...
						_errHandler.sync(this);
						_la = _input.LA(1);
						if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 37385542828032L) != 0)) {
							{
							setState(300);
							tfpdef();
							}
	...
	public final Return_stmtContext return_stmt() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 180181942944139312L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 12673L) != 0)) {
				{
				setState(543);
				testlist();
				}
		...
		try {
			...
			case NEWLINE:
				...
				do {
					...
					_errHandler.sync(this);
					_la = _input.LA(1);
				} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 252271912705842736L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 4206977L) != 0) );
				setState(764);
				match(DEDENT);
				}
				break;
	...
	public final Star_named_expressionsContext star_named_expressions() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 252239536982067248L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 12673L) != 0) );
			setState(795);
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (_la==COMMA) {
	...
	public final Sequence_patternContext sequence_pattern() throws RecognitionException {
		...
		try {
			...
			case OPEN_BRACK:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 216210721709490224L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 8449L) != 0)) {
					{
					setState(913);
	...
	public final AtomContext atom() throws RecognitionException {
		...
		try {
			...
			case OPEN_BRACK:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 252239536982067248L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 12673L) != 0)) {
					{
					setState(1177);
					testlist_comp();
					}
	...
	public final Yield_exprContext yield_expr() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 180181942960916528L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 12673L) != 0)) {
				{
				setState(1399);
				yield_arg();
				}
